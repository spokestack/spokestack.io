...
To get started with a free NLU model that’s compatible with Spokestack, [create a free account](/account/create) and upload your existing Alexa or Dialogflow interaction model. The following instructions for that process are paraphrased from our [export guide](/docs/integrations/export):
