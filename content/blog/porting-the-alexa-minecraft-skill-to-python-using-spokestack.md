...
author: will
tags: Apps, Engineering, Python, Tutorial, 3rd Party Integration
draft: false
hero: ../assets/blog/porting-the-alexa-minecraft-skill-to-python-using-spokestack.png
---

![Porting the Alexa Minecraft Skill to Python using Spokestack](../assets/blog/porting-the-alexa-minecraft-skill-to-python-using-spokestack.png)
...
1. [Create](/account/create) a Spokestack account.
1. Click "Add token" in the [API Credentials dashboard](/account/settings#api).
